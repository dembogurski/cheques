...
<div class="der">
    ...
    <span class="movible" style="margin:{conf_fecha_pago}" data-conf="right" id="fecha_pago"> {query0_chq_fecha_pag} </span>
        ...
        <div class="izq"><div  class="movible"  style="font-size:11px;margin:{conf_benef}" data-conf="left" id="benef"> {query0_chq_benef}{rayas} </div></div>       
        <div class="izq"><span class="movible" style="line-height: 18pt;font-size:11px;margin:{conf_valor_letras}" data-conf="left" id="valor_letras"> {letras}.-----</span>   </div> 
		</td>
</tr>
</table>
