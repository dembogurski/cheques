...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "text",
        F_MAKE_QUERY_ => "1",
        F_QUERY_ => "'SELECT COUNT(*) FROM bcos_chq WHERE chq_estado = '+estado.getStr()+' AND chq_cta =  '+cuenta.getStr()+' '",
        F_QUERY_REF_ => "estado.hasChanged() || cuenta.hasChanged() ",
        F_BROW_ => "1",
        F_NODB_ => "1",
		F_LENGTH_ => "6",
        F_ORD_ => "66",
...
$Obj->Add(
    array(
        ...
        F_TYPE_ => "subform",
        F_OPTIONS_ => "'chq_cta='+cuenta.getStr()+' and chq_estado = '+estado.getStr()+' and chq_num like concat(|{%}|,|{'+nro_chq.get() +'}|) '",
