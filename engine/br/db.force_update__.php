...
$Obj->alias = "Forçando Actualizacão do sistema";
$Obj->help = "Forçando Actualizacão do sistema";
$Obj->copy_from = "";
$Obj->Inheritance = "";
...
$Obj->Add(
    array(
        F_NAME_ => "drop_table",
        F_ALIAS_ => "Actualizacão",
        F_HELP_ => "Actualizacão",
        F_TYPE_ => "text",
        F_MAKE_QUERY_ => "1",
...
$Obj->Add(
    array(
        ...
        C_SHOW_ => "true",
        C_VIEW_ => "false",
        F_FORMULA_ => "enableMessageButton('<<< Forçando actualizacão para o proximo login >>>',1500);",
        G_SHOW_ => "1",
        G_CHANGE_ => "1"));
