...
$Obj->SetAlias( "Creando nuevo Proyecto");
...
$Obj->Add(
	array(
	F_NAME_		=> "proj_name",
	F_ALIAS_	=> "Nombre del Proyecto", 
	F_HELP_		=> "Nombre del Proyecto",
	F_TYPE_		=> "text",
...
$Obj->Add(
    array(
        ...
        F_ORD_ => "35",
        C_VIEW_ => "false",
        C_SHOW_ => "proj_rpc_call.get()!='false'&&proj_create.get()=='Si'",
        F_FORMULA_ => "enableMessageButton('Ok!!! el projecto ha sido creado con exito!!!',2800);",
        G_SHOW_		=> '2147483647'
));
