...
$Obj->alias = "Force system update";
$Obj->help = "Force system update";
$Obj->copy_from = "";
$Obj->Inheritance = "";
...
$Obj->Add(
    array(
        F_NAME_ => "__lock",
        F_ALIAS_ => "Lock Insert/Accept button",
        F_HELP_ => "Lock Insert/Accept button",
        F_TYPE_ => "formula",
        F_NODB_ => "1",
        F_ORD_ => "2",
        C_VIEW_ => "false",
...
$Obj->Add(
    array(
        ...
        C_SHOW_ => "true",
        C_VIEW_ => "false",
        F_FORMULA_ => "enableMessageButton('<<< Forcing the system actualization for the next login! >>>',1500);",
        G_SHOW_ => "1",
        G_CHANGE_ => "1"));
